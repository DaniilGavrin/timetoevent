...
**Цель:** Рабочие таймеры countdown/countup + UI для управления событиями
...
#### Изменено
- eventsStore расширен: добавлены updateEvent, deleteEvent, toggleFavorite
- index.tsx использует useTimer хук вместо formatDistanceToNow
...
- `check_missed_reminders` при старте приложения
...
- Device ID в таблице settings (стабильный UUID устройства)
...
- Структура документации: добавлены INSTALL.md, USAGE.md, FAQ.md, TROUBLESHOOTING.md, API.md, PROTOCOL.md, CRYPTO.md, CONTRIBUTING.md
...
- Ссылки в документации: BACKLOG.md → TODO
...
- Файлы документации: `README.md`, `LICENSE`, `TODO`, `ARCHITECTURE.md`, `CHANGELOG.md`
